...
require_once '../app/Controllers/PuntoEcaController.php';
...
use App\Controllers\PuntoEcaController;
...
Ruta::getRutas('/gestor-eca', [PuntoEcaController::class, 'view_punto_eca']);
...
Ruta::getRutas('/publicacion', [PublicacionController::class, 'view_publicacion']);
